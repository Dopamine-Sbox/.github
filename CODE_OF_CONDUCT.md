...
reported privately through the affected repository's security reporting channel
or by asking an organization owner to establish private contact. Do not include
...
**Consequence:** A private, written warning that explains the violation and the
expected behavior, with a possible request for a public apology.
